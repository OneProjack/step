...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5688503831:AAFDKaOFZrR8cGCpOqIVlr2JtfL_3VjAwBI")
...
# ID Channel Database
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001597906476"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001785831449"))
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "5029255799 2013745499 5042563853").split())]
except ValueError:
